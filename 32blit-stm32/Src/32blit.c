...
void blit_init() {
    ...
    blit::api.dma2d_clear = dma2d_clear;
    blit::api.dma2d_RGBA_RGB  = dma2d_RGBA_RGB;
    blit::api.dma2d_hires_flip = dma2d_hires_flip;
    blit::api.dma2d_lores_flip = dma2d_lores_flip;
